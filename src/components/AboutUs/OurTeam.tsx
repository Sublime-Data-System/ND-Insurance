  ...
  const team = [
    {
      ...
      linkedin: 'https://www.linkedin.com/in/parth-desai-62299a17/',
    },
    {
      name: 'Dhruv Desai',
      role: 'Principal Officer',
      image: '/images/about-us/dhruv-desai.png', // replace with actual path
      imageSm: '/images/about-us/dhruv.png',
      bio: [
      ...
      linkedin: 'https://www.linkedin.com/in/dhruv-desai-10846580/', // add link
    },
    {
      name: 'Bijal Desai',
    ...
    },
    {
      ...
      linkedin: 'https://in.linkedin.com/in/naiya-ashra-585370146', // add link
    },
  ]
  ...
  return (
    <>
      ...
      <div className="w-full flex flex-col gap-5 ">
        <div className="pt-1 h-[32px] md:h-[45px] rounded-[42px] bg-[#F6FFDB] border-2 border-[#A9BF6838] w-[91px]  md:w-[131px] mx-auto mb-5 mt-32 flex items-center justify-center text-[14px] md:text-[18px]">
          Our Team
        </div>
