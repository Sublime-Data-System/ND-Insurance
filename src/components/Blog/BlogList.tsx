  ...
  return (
    <div className="w-full py-12 px-4 md:px-10 max-w-[1336px] mx-auto">
      <div className="mb-12 text-center">
        <H1Grey className="mb-4">Our Blogs</H1Grey>
        <H2 className="text-[#858585] max-w-5xl mx-auto">
      ...
      {posts.length === 0 ? (
        <div className="text-center py-20">
          <H2 className="text-[#858585]">No blog posts available yet. Check back soon!</H2>
        </div>
      ) : (
